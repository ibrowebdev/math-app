...
const emit = defineEmits(['start', 'scoreboard', 'practice'])
    ...
    <div :class="['text-center max-w-2xl mx-auto', showContent ? 'animate-slide-up' : 'opacity-0']">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <button
          id="practice-btn"
          @click="emit('practice')"
          class="px-8 py-4 rounded-2xl font-semibold text-white bg-gradient-to-r from-violet-600 to-blue-600 hover:from-violet-500 hover:to-blue-500 transition-all duration-300 shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 hover:scale-105 active:scale-95 cursor-pointer"
        >
          <span class="flex items-center gap-2">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
